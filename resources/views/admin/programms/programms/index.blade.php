                ...
                <div class="card-body">
                    <div class="">
                        <div class="container">
                            ...
                            @endif
                            <form action="{{ route('admin.programms.programms.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="program_libele">Wording</label>
                                    <input type="text" class="form-control @error('program_libele') is-invalid @enderror" id="program_libele" name="program_libele" value="{{ old('program_libele') }}" required min="2">
                                </div>
                                <div class="form-group">
                                    <label for="program_img">Image of program</label>
                                    <input type="file" name="program_img" id="program_img" class="form-control @error('program_img') is-invalid @enderror" required>
                                </div>

                                <div class="form-group">
                                    <label for="program_desc">Description</label>
                                    <textarea name="program_desc" id="program_desc" rows="5" class="form-control @error('program_desc') is-invalid @enderror" required>{{ old('program_desc') }}</textarea>
                                </div>
