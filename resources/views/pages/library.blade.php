    ...
    <div class="section-inner pad-top-200">
        <div class="container vertical-center">
            <div class="intro-text vertical-center text-center smoothie">
                <div class="intro-heading wow fadeIn heading-font" data-wow-delay="0.2s"><h1>Daara luqmane Al Hakiim - librairie</h1></div>
...
<div class="container text-dark p-3">
    ...
    <div class="header text-center p-3"><h2>Daara Luqman Al Hakiim en images</h2></div>
    <div class="row" p-3 mt-5>
        <div class="gallery">
